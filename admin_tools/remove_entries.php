...
<h3>Remove A Location</h3>	
	...
	<?php 
		...
		if(isset($_GET['submit']) && $_GET['submit'] == 'Delete'){
			...
			if($entry_type == '0'){
					echo '<p>You Must Enter A '.$entry_type.' Type To Delete!<p>';
					$error = 'true';
			}
			
			if($entry_to_delete == ''){
					echo '<p>You Must Enter A '.$entry_to_delete.' Name To Delete!<p>';
					$error = 'true';
			}
			...
			if($entry_type == 'Sensor'){//this has to be a different table
