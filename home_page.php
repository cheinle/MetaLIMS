...
<button class="small-button" type=button onClick="parent.location='<?php echo $root; ?>update_tables/update_air_sampler.php'" value='1'>Add a New Air Sampler</button></p>
