...
<fieldset>
	...
	<LEGEND  style="margin-left:1.5%;"><b>Display All Location Info:</b></LEGEND>
	<div class="vert-checkboxes">
	<label class="checkbox-label"><input type="radio" name="db_content"<?php if (isset($db_content) && $db_content=="location_all") echo "checked";?>value="location_all">Display All DB Location Content</label>
	</div>
